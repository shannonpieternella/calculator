 ...
 */
 ...
 export default function ResultContentTwo({ answers, currentQuestion }) {
    ...
    const [box3BelastingPercentage, setbox3BelastingPercentage ] = useState(32);
  ...
  useEffect(() => {
    ...
    useEffect(() => {
      ...
      useEffect(() => {
        ...
        setForfaitairVermogen(spaar/100*0.36)
        setForfaitairBeleggingen(overigeBezittingen/100*6.17)
        setForfaitairSchulden(aftrekBareSchulden/100*2.57)
  ...
  return (
    ...
    <div className="bg-white shadow rounded-lg p-4 mb-4">
      ...
      <div className="bg-gray-100 p-2 rounded mb-4">
        <h3 className="font-medium mb-2">Box 3 inkomsten en belasting – 2023 (voorlopig)</h3>
        ...
        <div className="flex justify-between">
          ...
          <span>{box3BelastingPercentage}% × {formatter.format(box3Inkomen)} =</span>
      ...
      <div className="bg-gray-100 p-2 rounded mb-4">
        ...
        <div className="flex justify-between mb-1">
          <span>Aftrekbare schulden</span>
         -{formatter.format(aftrekBareSchulden)}
